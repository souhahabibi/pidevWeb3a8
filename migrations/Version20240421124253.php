 ...
 */
final class Version20240421124253 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ingredient_meal (id INT AUTO_INCREMENT NOT NULL, ingredient_id INT NOT NULL, meal_id INT NOT NULL, INDEX meal_id (meal_id), INDEX ingredient_id (ingredient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
