 ...
 */
final class Version20240421123912 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit CHANGE id_fournisseur id_fournisseur INT NOT NULL, CHANGE nom nom VARCHAR(255) NOT NULL, CHANGE cout cout DOUBLE PRECISION NOT NULL, CHANGE description description VARCHAR(255) NOT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
