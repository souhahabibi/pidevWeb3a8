...
class UserController extends AbstractController
{
    ...
    #[Route('/profilecoach', name: 'app_profilcoach', methods: ['GET', 'POST'])]
    public function profile3(Request $request, EntityManagerInterface $entityManager, UserPasswordHasherInterface $userPasswordHasher): Response
    {
        // Récupérer l'ID de l'utilisateur à partir de la session ou de la requête
        $userId = $this->getUser()->getId();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_profilcoach', [], Response::HTTP_SEE_OTHER);
        }
